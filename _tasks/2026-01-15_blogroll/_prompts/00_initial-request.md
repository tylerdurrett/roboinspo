...
This is very much up in the air, and we will resolve the specifics in phase 1 B.

Now, let's first determine the tech solution that will best serve a "normalized DB" type of markdown-based system.

Please research the stack to determine the modern best solution, and present them to me here.
