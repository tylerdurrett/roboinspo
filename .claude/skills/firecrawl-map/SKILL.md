...
name: firecrawl-map
description: |
  Discover and list all URLs on a website, with optional search filtering. Only use when the user explicitly requests Firecrawl site mapping or directly invokes this skill.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
---
