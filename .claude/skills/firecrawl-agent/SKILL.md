...
description: |
  AI-powered autonomous data extraction returning structured JSON from complex sites. Only use when the user explicitly requests Firecrawl agent extraction or directly invokes this skill.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
---
