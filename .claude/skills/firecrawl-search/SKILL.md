...
description: |
  Web search with full page content extraction. Only use when the user explicitly requests Firecrawl search or directly invokes this skill. Do NOT replace built-in WebSearch — use that for standard searches.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
---
