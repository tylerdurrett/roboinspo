...
description: |
  Extract clean markdown from any URL, including JavaScript-rendered SPAs. Only use when the user explicitly requests Firecrawl scraping or directly invokes this skill. Do NOT replace built-in WebFetch — use that for standard URL fetching.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
---
